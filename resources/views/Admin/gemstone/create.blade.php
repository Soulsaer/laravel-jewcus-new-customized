...
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-bold mb-4">Create Gemstone</h1>
    
    <form action="{{ route('admin.gemstone.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div>
            <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Create Gemstone</button>
        </div>
    </form>
</div>
@endsection
